//
//  AureliaComplication.swift
//  AureliaComplicationExtension
//
//  watchOS complications for Aurelia
//
...
struct NowPlayingData {
    ...
    static func load() -> NowPlayingData {
        guard let defaults = UserDefaults(suiteName: "group.de.beutner.Aurelia") else {
            return .placeholder
        }
...
struct NowPlayingComplicationView: View {
    ...
    private var circularView: some View {
        ZStack {
            ...
            if entry.data.trackName == "Aurelia" {
    ...
    private var cornerView: some View {
        Image(systemName: "waveform")
            ...
            .foregroundColor(.cyan)
            .widgetLabel {
                Text(entry.data.trackName == "Aurelia" ? "Aurelia" : entry.data.trackName)
            }
    }
...
@main
struct AureliaComplicationWidget: Widget {
    let kind = "AureliaNowPlaying"
    ...
    var body: some WidgetConfiguration {
        ...
        .description("Shows what's playing on Aurelia")
        .supportedFamilies([
            .accessoryCircular,
