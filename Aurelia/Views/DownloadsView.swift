...
struct DownloadedTrackRow: View {
    ...
    var body: some View {
        Button {
            ...
            .padding(.vertical, 12)
            .background(Color.appMidBackground)
            ...
            ZStack {
                if let artwork = artworkImage {
                    ...
                    RoundedRectangle(cornerRadius: 12)
                        .fill(
                            LinearGradient(
                                colors: [Color.appAccent.opacity(0.3), Color.appSecondary.opacity(0.3)],
                                startPoint: .topLeading,
                                endPoint: .bottomTrailing
                            )
                        )
            ...
            ZStack {
                if let artwork = artworkImage {
                    ...
                    RoundedRectangle(cornerRadius: 20)
                        .fill(
                            LinearGradient(
                                colors: [Color.appAccent.opacity(0.4), Color.appSecondary.opacity(0.4)],
                                startPoint: .topLeading,
                                endPoint: .bottomTrailing
                            )
                        )
